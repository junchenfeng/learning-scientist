...
$$P(X_1|Y_1,Y_0) = \sum_{X_0} P(X_1,X_0|Y_1,Y_0)$$
$$P(X_0|Y_1,Y_0) = \sum_{X_1} P(X_1,X_0|Y_1,Y_0)$$

$$P(X_1,X_0|Y_1,Y_0) = \frac{P(X_1,X_0,Y_1,Y_0)}{\sum_{X_1}\sum_{X_0}P(X_1,X_0,Y_1,Y_0)}$$
...
---
# 例子
$$\pi=0.3, \ell=0.4, s=0.1, g=0.3,Y_1=1, Y_0=0$$
$$P(X_1=1,X_0=1)=0.3$$
$$P(X_1=1,X_0=0)=0.28$$
$$P(X_1=0,X_0=0)=0.42$$
$$P(Y_1,Y_0,X_1=1,X_0=1) = 0.021$$
$$P(Y_1,Y_0,X_1=1,X_0=0) = 0.1764$$
$$P(Y_1,Y_0,X_1=0,X_0=0) = 0.0882$$

$$P(X_1=1,X_0=1|Y)\approx 0.07$$
$$P(X_1=1,X_0=0|Y)\approx 0.62$$
$$P(X_1=0,X_0=0|Y)\approx 0.31$$
